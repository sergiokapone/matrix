...
def interactive_fill_mappings(yaml_file=yaml_file):
    """
...
def validate_data(yaml_file=yaml_file):
    """
...
def create_yaml_template(filename="curriculum.yaml"):
    ...
    with open(filename, 'w', encoding='utf-8') as f:
        yaml.dump(template, f, allow_unicode=True, default_flow_style=False, indent=2, sort_keys=False)
